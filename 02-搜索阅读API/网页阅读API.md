...
网页内容分析能力建议理解为“已开通网页阅读或网页内容理解能力的模型，通过标准聊天接口完成网页内容处理”。

ApiHalo 对外不要求调用单独的专有网页接口，优先仍按标准聊天接口接入。
...
- 该模型必须已经对当前 Key 开放网页内容理解能力
- 是否可用，以 `/v1/models` 和实际账号能力为准

## 四、注意事项

- 不要默认所有聊天模型都具备网页内容分析能力
- 如果业务必须读取实时网页内容，请先做一次最小请求验证
